...
public class TicTacToe {
	...
	public static void boucleJeu(String joueur1, String joueur2,  int[] score) {	
		...
		while(continuer ){
			...
			while(!choix.equals("oui") || !choix.equals("non")){
				...
				System.out.println("Voulez-vous commencer a jouer ? (Oui ou Non) : ");			
			...
			do {
				...
				// Joueur 1
				if (i % 2 == 0) {
					System.out.print("Tour du joueur 1 (ex: 3c) : "); 
					
					// joueur1.getJoueur() c'est X
					onJoue(morpion, joueur1);				

				// Joueur 2
				} else {
					System.out.print("Tour du joueur 2 (ex: 3c) : ");

					// joueur2.getJoueur() c'est 0
					onJoue(morpion, joueur2);
				}
			...
			if(e == 9){
				...
				scoreAfficher(score, annotationJoueur1, annotationJoueur2);
		...
		//TicTacToe.verification() doit revenir true pour gagner
		// sinon on repete boucle	TicTacToe.verification(false)== false
		//
	...
	public static void scoreAfficher(int[] score, String joueur1,String joueur2) {
